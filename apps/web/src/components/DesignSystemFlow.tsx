...
function buildCreationAgentPrompt(
  ...
  return [
    ...
    '- Write `SKILL.md` as an agent-usable skill entry, not only a loose Markdown note. Include YAML frontmatter with `name`, `description`, and `user-invocable`, then tell future agents to read README.md, DESIGN.md, colors_and_type.css, preview/, assets/, fonts/, source_examples/, and ui_kits/app/.',
...
function buildSourceContextManifest(
  ...
  sections.push(
    ...
    '- SKILL.md should include YAML frontmatter with `name`, `description`, and `user-invocable`, plus usage guidance that points agents at README.md, DESIGN.md, colors_and_type.css, preview/, assets/, fonts/, source_examples/, and ui_kits/app/.',
